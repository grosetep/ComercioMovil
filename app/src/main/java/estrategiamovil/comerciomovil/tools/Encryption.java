...
public class Encryption {
    ...
    public static Encryption getDefault() {
        try {
            String key = Constants.seedValue;
            String salt = "estrategiam";

            return Builder.getDefaultBuilder(key, salt, new byte[16]).build();
     ...
     */
    private static  String encrypt(String data) throws UnsupportedEncodingException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, InvalidKeyException, InvalidKeySpecException, BadPaddingException, IllegalBlockSizeException {
     ...
     * @return the encrypted String or {@code null} if you send the data as {@code null}
     */
    public static String encryptOrNull(String data) {
        try {
            return encrypt(data);
        } catch (Exception e) {
            Log.e(TAG, e.getMessage(), e);
     ...
     */
    private static SecretKey getSecretKey(char[] key) throws NoSuchAlgorithmException, UnsupportedEncodingException, InvalidKeySpecException {
     ...
     */
    private static char[] hashTheKey(String key) throws UnsupportedEncodingException, NoSuchAlgorithmException {
